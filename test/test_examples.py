...
from examples import simple, cuda_graph, cpu_backup, rl_example, multi_device, training_engine, nested_region, artifact_backends
...
def test_artifact_backends():
    _test_core(artifact_backends.run, hook_mode="torch")
