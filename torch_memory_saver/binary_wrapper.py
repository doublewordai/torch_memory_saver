...
class BinaryWrapper:
    ...
    def set_config(
        ...
        self.cdll.tms_set_disk_backup_path(disk_backup_path.encode("utf-8"))
...
def _setup_function_signatures(cdll):
    ...
    cdll.tms_set_disk_backup_path.argtypes = [ctypes.c_char_p]
    cdll.tms_get_disk_backup_path.restype = ctypes.c_char_p
